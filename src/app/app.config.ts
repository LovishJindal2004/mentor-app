            ...
            useFactory: (router: Router) =>{
                ...
                routes.forEach(route => {
                    if (route.canActivate) {
                        route.canActivate = [tenantGuard, ...route.canActivate];
                    } else {
                        route.canActivate = [tenantGuard];
                    }
                    if (route.canActivateChild) {
                        route.canActivateChild = [tenantGuard, ...route.canActivateChild];
                    } else {
                        route.canActivateChild = [tenantGuard];
                    }
                });
